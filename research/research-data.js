...
(function () {
  ...
  var paperDetails = {
    ...
    "joint-likelihood": {
      ...
      plots: [
        { src: "paper-figures-web/joint-likelihood-rotation-curve-prior-comparison.webp", full: "paper-figures-full/joint-likelihood-rotation-curve-prior-comparison.png", caption: "Recreated rotation curves from the mean posterior parameters obtained with weak flat priors and strong Gaussian priors on the disk parameters. Dashed curves show the dark-matter contribution, dotted curves show the visible-matter contribution, and solid curves show the combined rotation curve." },
        { src: "paper-figures-web/joint-likelihood-rhodm-rs-lsr-priors.webp", full: "paper-figures-full/joint-likelihood-rhodm-rs-lsr-priors.png", caption: "Posterior probability contours in local dark matter density rho_DM and halo scale radius r_s for different Local Standard of Rest choices and visible-matter prior assumptions." },
        { src: "paper-figures-web/joint-likelihood-rhodm-sigma-comparison.webp", full: "paper-figures-full/joint-likelihood-rhodm-sigma-comparison.png", caption: "Visible-matter and dark-matter parameter-space comparison after combining rotation-curve and local-kinematic constraints, shown against representative literature determinations." },
        { src: "paper-figures-web/joint-likelihood-vdf-rotation-curve-comparison.webp", full: "paper-figures-full/joint-likelihood-vdf-rotation-curve-comparison.png", caption: "Rotation-curve fits and corresponding velocity-distribution functions compared with the standard halo model." },
        { src: "paper-figures-web/joint-likelihood-vdf-shm-comparison.webp", full: "paper-figures-full/joint-likelihood-vdf-shm-comparison.png", caption: "Velocity-distribution functions inferred from Bhattacharjee et al. and Gaia DR3 rotation-curve constraints compared with the standard halo model." },
        { src: "paper-figures-web/joint-likelihood-mcmc-corner-comparison.webp", full: "paper-figures-full/joint-likelihood-mcmc-corner-comparison.png", caption: "MCMC corner-plot comparison of dark halo, disk surface density, bulge density, and scale parameters across representative runs." },
      ]
    },
    "surface-density": {
